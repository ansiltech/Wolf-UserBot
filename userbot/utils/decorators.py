...
def errors_handler(func):
    async def wrapper(errors):
        try:
            ...
            text = "**WolfUserbot Error report**\n\n"
            link = "[here](https://t.me/ansiltechteam)"
...
def register(**args):
    ...
    def decorator(func):
        if not disable_edited:
            wolfub.add_event_handler(func, MessageEdited(**args))
        wolfub.add_event_handler(func, NewMessage(**args))
        try:
